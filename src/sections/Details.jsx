      ...
      <div className="container image-section-container">
        ...
        <div className="content-container">
          <div className="detail-row header-section">
            ...
            <p><em>New this year</em> on Thursday October 19th, is a Pre-Event Vendor Showcase where our vendors will be signing up to give live-focused demos of their product or service. This is a great opportunity to learn about the tools, services, and products that can help you run your online business more effectively. The price is included in the cost of the normal conference and space is limited. <em className="highlight">Register early and click <a href="https://docs.google.com/spreadsheets/d/1mSsjgzGZT0mfMvtHwywiBysTrbQ13DAccPJcuZuyNU0/edit#gid=0" target="_blank" rel="noopener noreferrer">here to sign up to attend a vendor demo.</a></em></p>
          </div>
